  ...
  return (
    <footer className="w-full divide-y mt-5">
        ...
        <div className="flex p-3 xs:flex-col sm:flex-col md:flex-row text-[#f25042]">
            ...
            <div className="text-lg font-semibold font-mono align-middle flex justify-center md:w-1/2">
                <p>Creado con ❤️</p>
            </div>
        ...
        <div className="text-center text-xs font-mono divide-y-reverse p-3 text-[#020826]">
            <p>Este portafolio fue creado con Vite + <a href="https://es.react.dev/">
                <i className="devicon-react-original colored text-lg mx-2"></i>
            </a> y 
            <a href="https://tailwindcss.com/">
                <i className="devicon-tailwindcss-plain colored text-lg mx-2"></i>  
            </a></p>
        </div>
